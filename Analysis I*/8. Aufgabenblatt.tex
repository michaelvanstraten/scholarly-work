...
\begin{enumerate}
	...
	\item Für jede positive reelle Zahl $a$ ist die Einschränkung $\log [a, \infty[ : [a, \infty[ \rightarrow \mathbb{R}$ gleichmäßig stetig.
	\item Machen Sie eine Literaturrecherche, und finden Sie die Definition von Lipschitzstetigkeit für reelle Funktionen heraus. Schreiben Sie diese nieder.
