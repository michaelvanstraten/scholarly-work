...
\begin{proof}
    ...
    \begin{enumerate}
        \item Zunächst versuchen wir $\frac{1+i\sqrt{3}}{1-i\sqrt{3}}$ zu vereinfachen:
              ...
              Betrachten wir jetzt den Winkel zwischen dem Punkt und $(1, 0)$. Er ergibt sich
              als Bogen von $120^\circ$ oder $\frac{2\pi}{3}$ Radian.
              ...
              $cos\left(\frac{2 \pi}{3}\right) + i \cdot sin\left(\frac{2 \pi}{3}\right)$
              darstellen.

              Wandeln wir dies jetzt in die polare Form um, erhalten wir $e^{i\frac{2 \pi
                          }{3}}$.
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item Für $g$ Betrachten wir wiederum einen generischen Punkt $z \in \field{C}$. \[
              ...
              Somit ergibt sich die Bezeichnung \qouted{Inversion an der Einheitskreislinie},
