...
public class KochSchneeflocke {
    ...
    public static void zeichneKochKurve(int tiefe, double x1, double y1, double x5, double y5) {
        ...
        double x2 = x1 + 1.0 / 3 * (x5 - x1);
        double y2 = y1 + 1.0 / 3 * (y5 - y1);

        double x3 = 1.0 / 2 * (x1 + x5) + Math.sqrt(3) / 6 * (y1 - y5);
        double y3 = 1.0 / 2 * (y1 + y5) + Math.sqrt(3) / 6 * (x5 - x1);

        double x4 = x1 + 2.0 / 3 * (x5 - x1);
        double y4 = y1 + 2.0 / 3 * (y5 - y1);

        zeichneKochKurve(tiefe, x1, y1, x2, y2);
        zeichneKochKurve(tiefe, x2, y2, x3, y3);
        zeichneKochKurve(tiefe, x3, y3, x4, y4);
        zeichneKochKurve(tiefe, x4, y4, x5, y5);
    }
}
