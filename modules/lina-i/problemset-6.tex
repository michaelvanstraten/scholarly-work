...
\begin{proof}
    ...
    Um zu zeigen, das $(R, \oplus, \odot)$ einen Vektorraum über $K$ bildet
    muss gezeigt werden, dass $(R, \oplus)$ eine kommutative Gruppe bildet.
    Sowie das die folgenden Eigenschaften der Skalarmultiplikation erfüllt
    sind: \begin{align}
...
\begin{enumerate}
    \item Sind die folgenden Teilmengen Untervektorräume von $\mathbb{R}^2$?
          ...
          \end{enumerate}
    \item Sei $x \in \mathbb{R}$. Bezeichne $\mathbb{R}[x] := P[x]$ den
          Vektorraum der Polynome über $\mathbb{R}$. Sind die folgenden
          Teilmengen Untervektorräume von $R[x]$?
          \begin{enumerate}[label=\alph*)]
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item Wiederlegung zweier Aussagen
              ...
              Da \(R^2 \not \subseteq \emptyset\), trivialerweise, ist die
              Aussagen \(\operatorname{Span} U_1 \cap \operatorname{Span} U_2
              \subseteq \operatorname{Span}(U_1 \cap U_2)\) widerlegt.
              \checkmark
        ...
        \item Beweis oder Wiederlegung zweier Aussagen
              \begin{enumerate}[label=\alph*)]
                  ...
                  \item $\operatorname{Span}(U_1 + U_2) \not\supseteq \operatorname{Span} U_1 + \operatorname{Span} U_2$ da:
                        ...
                        Nehme $v \in V$ und $U_1 = \set{v}$ $U_2 = \set {-v}$,
                        somit ist $U_1 + U_2 = \emptyset = \operatorname{Span}
                        \emptyset$ aber $\operatorname{Span} U_1 +
