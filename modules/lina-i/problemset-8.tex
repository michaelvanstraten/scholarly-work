...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item Betrachten wir einen Vektor $p(t)$ in $\mathbb{R}_{\leq 3}[t]$,
              ...
              Somit ist $\dim_{\mathbb{R}}(U) = 2$, da $B$ zwei Elemente
              enthält.
        \item Um die Basis $B$ von $U$ zu einer Basis von $\mathbb{R}_{\leq
              3}[t]$ zu erweitern, wählen wir $1, t \in \mathbb{R}_{\leq
              3}[t]$. Damit ist $B \cup \{1, t\}$ die erweiterte Basis.
    \end{enumerate}
\end{proof}
\end{problem}
